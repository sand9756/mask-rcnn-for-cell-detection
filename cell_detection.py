# -*- coding: utf-8 -*-
"""cell detection.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZP59u6x2ZsJOJ9etuRHcmHaN1uKMk8-Q
"""
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            #image = skimage.io.imread(image_path) ## read image file
...
def color_splash(image, mask):
    ...
    gray = skimage.color.gray2rgb(skimage.color.rgb2gray(image)) * 65,535
